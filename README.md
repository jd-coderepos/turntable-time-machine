...
* 🕰️ Era-to-era routing across the 1960s, 1970s, 1980s, 1990s, 2000s, 2010s, and 2020s
...
* 🎙️ Six fictional DJ personas with original intro templates
...
* 🕰️ `music_eras.json` defines eras, genres, safe prompt styles, BPM ranges, instruments, sonic traits, and avoid notes.
* 🎙️ `dj_personas.json` defines six fictional hosts, including The Midnight Radio Curator and The Neon Signal Host.
...
* ✍️ `lyric_themes.json` defines compact lyric themes such as Future city, Night drive, Radio signal, and Time travel.
